...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-slate-900 dark:text-slate-100 overflow-x-hidden">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 glass-dark bg-slate-900/50 backdrop-blur-lg">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <Link href="/login" className="px-6 py-2 hover:bg-slate-800 rounded-lg transition-colors border border-slate-700">Login</Link>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl font-black mb-8 leading-[0.95] tracking-tight text-slate-100 italic">
                PAYMENTS <br />
                THAT FEEL <br />
                <span className="bg-gradient-to-r from-indigo-500 to-emerald-400 bg-clip-text text-transparent">WEIGHTLESS.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/register" className="btn-primary py-4 px-10 text-lg flex items-center justify-center gap-2 group">
          ...
          <div className="lg:w-1/2 relative group">
            ...
            >
              <div className="w-[340px] h-[580px] sm:w-[380px] sm:h-[620px] bg-slate-900 rounded-[50px] p-4 border-8 border-slate-800 shadow-2xl overflow-hidden shadow-indigo-500/20">
                <div className="h-full w-full bg-slate-950 rounded-[36px] p-6 relative flex flex-col gap-6">
                  {/* Mock UI */}
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="text-center">
              <div className="text-4xl font-bold bg-gradient-to-t from-slate-100 to-indigo-400 bg-clip-text text-transparent mb-2">
                {stat.value}
              </div>
      ...
      <section className="py-32 px-6 container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="p-8 rounded-[32px] bg-slate-900/40 border border-slate-800 hover:border-indigo-500/50 transition-colors group">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[100, 500, 1000, 2000].map(amt => (
              <div key={amt} className="p-6 rounded-3xl bg-slate-900 border border-slate-800 hover:border-indigo-500 transition-all group cursor-pointer shadow-xl">
